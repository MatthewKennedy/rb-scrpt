...
Gem::Specification.new do |s|
  ...
  s.summary="This is a fork of the fork, of the original rb-appscript. Ruby AppleScript (rb-scrpt) is a high-level, user-friendly Apple event bridge that allows you to control scriptable Mac OS X applications using ordinary Ruby scripts."
